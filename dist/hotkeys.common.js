...
function unbind(keysInfo) {
    ...
    if (!keysInfo) {
        Object.keys(_handlers).forEach(function (key) { return delete _handlers[key]; });
    }
...
// 解除绑定某个范围的快捷键
var eachUnbind = function (_a) {
    var key = _a.key, scope = _a.scope, method = _a.method, _b = _a.splitKey, splitKey = _b === void 0 ? '+' : _b;
...
if (typeof window !== 'undefined') {
    var _hotkeys_1 = window.hotkeys;
    hotkeys.noConflict = function (deep) {
        if (deep && window.hotkeys === hotkeys) {
            window.hotkeys = _hotkeys_1;
        }
        return hotkeys;
    };
